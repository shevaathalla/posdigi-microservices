    ...
    "paths": {
        ...
        "/auth/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Registration details (can include employee_data)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/auth/validate": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Token (optional if provided in body)",
                        "name": "token",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "dto.RegisterRequest": {
            ...
            "properties": {
                ...
                "employee_data": {
                    "$ref": "#/definitions/dto.EmployeeDataRequest"
                },
                "password": {
                    "type": "string",
                    "minLength": 6
