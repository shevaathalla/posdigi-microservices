...
// @version 1.0
// @description Attendance service for employee clock-in/clockout and work hours tracking
// @host localhost:8003
// @BasePath /
func main() {
	...
	// Start server
	app.Logger.Infof("Attendance Service starting on port %s", app.getPort())
