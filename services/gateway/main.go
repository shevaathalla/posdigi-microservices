...
// @version 1.0
// @description API Gateway for microservices - handles routing, authentication, and rate limiting
// @host localhost:8000
// @BasePath /
func main() {
	...
	// Start server
	app.Logger.Infof("Gateway Service starting on port %s", app.getPort())
